...
export default function GutsVirtualCampus() {
      ...
      <div className="gu-container">
        <div className="mx-auto mb-8 max-w-3xl text-center">
          ...
          <p className="mt-2 text-[16px] text-[#64748B]">
            Explore our vibrant, state-of-the-art campus, smart classrooms, research centers, and sports facilities.
          </p>
        </div>
        ...
        <div
          ...
          className="group relative h-[280px] sm:h-[380px] md:h-[480px] w-full overflow-hidden rounded-[24px] border border-[#E2E8F0] shadow-xl cursor-pointer"
        >
          <Image
