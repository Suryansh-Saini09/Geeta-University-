...
export const phdLaw: CoursePageData = {
  id: "phd-law",
  schoolSlug: "geeta-global-law-school",
  slug: "phd-law",
  seo: {
    title: "PhD in Law in India | Doctorate of Law (PhD Law Degree) at GU",
    description:
      "Apply for the PhD in Law degree at Geeta University in India. Know about eligibility, admission process, entrance exams, & how to apply.",
    keywords: [
      "Ph.D in Law",
      "PhD Law India",
      "Doctorate of Law Haryana",
      "Geeta Global Law School PhD Law",
      "Ph.D Admissions 2026",
    ],
    canonical:
      "https://geetauniversity.edu.in/programs/geeta-global-law-school/phd-law",
  },
  hero: {
    title: "Ph.D. in Law",
    description: "",
    image: "/programs/law/phd-law/phd-law-hero.jpg",
  },
  quickInfo: {
    program: "Ph.D. in Law",
  ...
  learningOutcomes: [
    ...
    "Formulate legal policies and contribute to national and international legislative reforms",
    "Master UGC and BCI compliant teaching methodologies for higher education in law",
    "Publish high-impact articles in peer-reviewed and indexed legal journals",
    "Lead academic institutions, public policy research centers, and judicial academies",
  ],
  admission: {
    eligibility:
  ...
  career: {
    ...
    govtRoles: [
      ...
      },
      {
        ...
        description:
          "Govt Legal Research Departments · Public Policy Think Tanks · International Bodies (UN, WHO, UNESCO) · NGOs (Human Rights, Environment & Gender Studies)",
      },
      {
        title: "Judiciary & Public Sector",
        description:
          "Judicial Academies · Government Legal Officers · Legislative Drafting Positions",
      },
    ],
    privateRoles: [
      {
        ...
        description:
          "Legal Consultant · Corporate Governance Advisor · Compliance Strategist · Research Head in Law Firms",
      },
      {
        title: "Independent Career",
        description:
          "Author & Legal Researcher · Consultant (National & International Projects)",
      },
    ],
  },
  faculty: [
  ...
  testimonials: [
    {
      ...
      text: "Geeta Global Law School provided me with an excellent platform to enhance my legal research skills and deepen my understanding of the judicial system. The supportive learning culture motivated me to achieve academic excellence.",
    },
    {
  ...
  faqs: lawFaqs,
  cta: {
    title: "Ready to pursue Ph.D. in Law?",
    description:
      "Apply now at Geeta University and conduct advanced legal research under expert guidance in a research-driven environment.",
