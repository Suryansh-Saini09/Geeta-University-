...
import { lawFaqs } from "@/data/programs/schools/law";

export const llm: CoursePageData = {
  id: "llm",
  schoolSlug: "geeta-global-law-school",
  slug: "llm",
  seo: {
    title: "Best LLM Law University in India | LLM Admission Open at GU",
    description:
      "Pursue a one-year Law Degree LLM at Geeta University, a reputed LLM university in India offering advanced legal education and career-focused training.",
    keywords: [
      "LLM",
      "Master of Laws",
      "LLM Admissions 2026",
      "LLM Colleges Delhi NCR",
      "Geeta Global Law School LLM",
    ],
    canonical:
      "https://geetauniversity.edu.in/programs/geeta-global-law-school/llm",
  },
  hero: {
    title: "LL.M. – Master of Laws",
    description: "",
    image: "/programs/law/llm/LLM-Master-of-Laws-Hero.jpg",
  },
  quickInfo: {
  ...
  subjects: [
    ...
    "Judicial Process & Case Law Analysis",
    "Law & Justice in a Globalizing World",
    "Public Policy & Legal Reform",
    "Elective Specialization Papers",
    "Seminar Presentations & Dissertation Writing",
    "Research Internship & Legal Aid Clinic Participation",
  ],
  learningOutcomes: [
    "Develop advanced legal research and analytical skills",
    "Attain subject-matter specialization in constitutional or commercial law",
    "Produce publishable academic research and policy recommendations",
    "Build strong foundations for Ph.D., UGC-NET, or judiciary exams",
    "Excel in litigation, international law, or academic leadership",
  ],
  admission: {
    eligibility:
    ...
    reasons: [
      {
        ...
        description:
          "Provides distinct high-demand specialization tracks including Corporate & Commercial Law, Constitutional Law, Criminal Law, and Cyber Law.",
      },
      {
        title: "Expert Legal Faculty",
        description:
          "Learn from renowned legal scholars, former Vice Chancellors, practitioners, and corporate legal experts.",
      },
      {
        title: "Moot Courts & Experiential Learning",
        description:
          "State-of-the-art Moot Court Hall, judgment writing labs, and legal aid clinics integrated into course credits.",
      },
      {
        title: "Career & Placement Support",
        description:
          "Dedicated placement cell connecting graduates to top law firms, corporate legal divisions, courts, and research institutions.",
      },
    ],
  },
  career: {
    ...
    govtRoles: [
      {
        ...
        description:
          "Civil Judge, Judicial Officer, Public Prosecutor, and Government Legal Advisor.",
      },
      {
        title: "Supreme Court & High Court Advocacy",
        description:
          "Advocate, Law Clerk, Legal Researcher, and Constitutional Law Consultant.",
      },
      {
        title: "Government & Regulatory Legal Departments",
        description:
          "Legal Officer in Bar Council of India, RBI, and National Human Rights Commission.",
      },
    ],
    privateRoles: [
      {
      ...
      },
      {
        ...
        description:
          "Law Professor, Guest Faculty, and Researcher at National Law Universities & UN Organizations.",
      },
    ],
  },
  faculty: [
  ...
  learningSpaces: {
    ...
    spaces: [
      ...
      {
        title: "Law Library & Digital Research",
  ...
  faqs: lawFaqs,
  cta: {
    title: "Ready to pursue LL.M. – Master of Laws?",
    description:
      "Apply now at Geeta University and specialize in high-demand legal fields with world-class faculty and practical moot court exposure.",
