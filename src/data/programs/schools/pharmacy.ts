...
export const pharmacySchool: ProgramPageData = {
  ...
  featuredPrograms: {
    ...
    cards: [
      ...
      },
      {
        ...
        iconName: "Lightbulb",
        points: [
          "Frontier Drug Research",
          "Scopus Indexed Publications",
          "Patent Filing & Grants",
        ],
      },
    ],
  },
  ...
  placement: {
    ...
    recruiters: [
      { name: "Zantac", color: "#e8871a", logo: "/programs/pharmacy/recruiters/zantac.png" },
      { name: "Pfizer", color: "#1b4b8f", logo: "/programs/pharmacy/recruiters/pfizer.png" },
      { name: "Truworth Healthcare", color: "#0a1f44", logo: "/programs/pharmacy/recruiters/truworth.png" },
      { name: "Torrent Pharma", color: "#006699", logo: "/programs/pharmacy/recruiters/torrent.png" },
      { name: "Sun Pharma", color: "#ef3340", logo: "/programs/pharmacy/recruiters/sun_pharma.png" },
      { name: "Alembic Pharmaceuticals", color: "#d89a2b", logo: "/programs/pharmacy/recruiters/alembic.svg" },
      { name: "Laborate Pharmaceuticals", color: "#1476bd", logo: "/programs/pharmacy/recruiters/laborate.png" },
      { name: "Stenkem Biolife", color: "#232f3e", logo: "/programs/pharmacy/recruiters/stenkem.png" },
      { name: "Abbott", color: "#1c6dd0", logo: "/programs/pharmacy/recruiters/abbott.svg" },
      { name: "Glenmark", color: "#9d245d", logo: "/programs/pharmacy/recruiters/glenmark.svg" },
      { name: "Apollo Hospitals", color: "#168acb", logo: "/programs/pharmacy/recruiters/apollo.svg" },
      { name: "Fortis Healthcare", color: "#2b66c2", logo: "/programs/pharmacy/recruiters/fortis.svg" },
      { name: "Max Healthcare", color: "#c4242d", logo: "/programs/pharmacy/recruiters/max_healthcare.svg" },
      { name: "Cadila Pharmaceuticals", color: "#003366", logo: "/programs/pharmacy/recruiters/cadila.svg" },
      { name: "Cipla", color: "#1476bd", logo: "/programs/pharmacy/recruiters/cipla.svg" },
      { name: "Mankind Pharma", color: "#e31837", logo: "/programs/pharmacy/recruiters/mankind.svg" },
      { name: "Dr. Reddy's Laboratories", color: "#1b365d", logo: "/programs/pharmacy/recruiters/dr_reddys.svg" },
    ],
    avgPackage: "₹4.85 LPA",
    ...
    disclaimer: "Placement session 2025-26 ongoing across corporate campus drives and hospital internships.",
    sectorChartImage: "/chart.png",
    sectorLegend: [
      { label: "Formulation & Production", value: "35.2%", color: "#f2ad00" },
      { label: "Quality Assurance & QC", value: "22.4%", color: "#ef6a22" },
      { label: "Clinical Research & Pharmacovigilance", value: "18.1%", color: "#ef2856" },
      { label: "Pharma Sales & Marketing", value: "12.5%", color: "#df4ab3" },
