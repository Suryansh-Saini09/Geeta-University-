...
export const pharmacySchool: ProgramPageData = {
  ...
  faqs: [
    {
      question: "Is Geeta Institute of Pharmacy approved by PCI?",
      answer: "Yes, all pharmacy programs at Geeta Institute of Pharmacy are approved by the Pharmacy Council of India (PCI) and adhere to government norms and university guidelines.",
    },
    {
      question: "What laboratories and research facilities are available?",
      answer: "We have state-of-the-art laboratories including Pharmaceutics Lab, Pharmacology Lab with simulated software, Pharmaceutical Chemistry & Analysis Lab with modern spectrophotometers and HPLC, Pharmacognosy Lab, and a dedicated Machine Room.",
    },
    {
      question: "What career paths are open after B.Pharm?",
      answer: "B.Pharm graduates can pursue roles in Formulation & R&D, Quality Assurance & Quality Control, Clinical Research, Regulatory Affairs, Hospital Pharmacist, Drug Inspector, Pharma Sales & Brand Management, or opt for higher studies like M.Pharm / MBA.",
    },
    {
      question: "What is the eligibility for B.Pharm and D.Pharm?",
      answer: "For D.Pharm, candidates must have passed 10+2 with Physics, Chemistry and Biology/Math with 50%. For B.Pharm, 10+2 with 55% marks in PCM/PCB.",
    },
  ],
};