...
export const pharmacySchool: ProgramPageData = {
  ...
  placement: {
    ...
    recruiters: [
      { name: "Zentech Pharma", color: "#e8871a", logo: "/programs/pharmacy/recruiters/zentech.svg" },
      { name: "Pfizer", color: "#1b4b8f", logo: "/programs/pharmacy/recruiters/pfizer.svg" },
      { name: "Trueworth Healthcare", color: "#0a1f44", logo: "/programs/pharmacy/recruiters/trueworth.svg" },
      { name: "Alembic Pharmaceuticals", color: "#d89a2b", logo: "/programs/pharmacy/recruiters/alembic.svg" },
      { name: "Sun Pharma", color: "#ef3340", logo: "/programs/pharmacy/recruiters/sun_pharma.svg" },
      { name: "Laborate Pharmaceuticals", color: "#1476bd", logo: "/programs/pharmacy/recruiters/laborate.svg" },
      { name: "Stenkem Biolife", color: "#232f3e", logo: "/programs/pharmacy/recruiters/stenkem.svg" },
