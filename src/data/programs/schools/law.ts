...
export const lawSchool: ProgramPageData = {
  ...
  placement: {
    ...
    recruiters: [
      { name: "Shardul Amarchand Mangaldas", color: "#168acb", logo: null },
      { name: "Khaitan & Co", color: "#003366", logo: null },
      { name: "AZB & Partners", color: "#b32428", logo: null },
      { name: "Trilegal", color: "#1e3a8a", logo: null },
      { name: "Luthra and Luthra", color: "#d97706", logo: null },
      { name: "Cyril Amarchand Mangaldas", color: "#047857", logo: null },
      { name: "Deloitte Legal", color: "#86efac", logo: null },
      { name: "PwC Legal Advisory", color: "#f97316", logo: null },
      { name: "EY India", color: "#ffe600", logo: null },
      { name: "KPMG Advisory", color: "#00338d", logo: null },
    ],
    avgPackage: "₹6.5 LPA",
    avgPackageNote:
