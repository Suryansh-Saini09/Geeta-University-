...
export const computerScienceSchool: ProgramPageData = {
  slug: "school-of-computer-science-and-engineering",
  ...
  seo: {
    ...
    keywords: [
      ...
      "best B.Tech. CSE university in haryana",
      "best engineering university in haryana",
      "computer science and engineering university in haryana",
      "university of engineering",
      "geeta university",
      "gu",
      "Best Colleges For Computer Science In Delhi Ncr",
      "best university for btech",
      "best university for b tech computer science",
      "Best Private Engineering Colleges In Haryana",
      "Top Engineering Colleges In Haryana",
      "Best Engineering Colleges In Haryana",
      "Private Engineering Colleges In Haryana",
      "Top Private Engineering Colleges In Haryana",
      "Best Engineering Colleges In Delhi Ncr",
      "Top Engineering Colleges In Delhi Ncr",
      "Top 10 Engineering Colleges In Delhi Ncr",
      "Top 10 Engineering Colleges In Haryana",
  ...
  hero: {
    bannerOnly: false,
    image: "https://geetauniversity.edu.in/uploads/all/2546/cse-banner.webp",
    ...
    slides: [
      ...
      },
      {
        ...
        description:
          "Earn credentials from AWS, Microsoft Azure, Cisco, Oracle, and Red Hat. Step out ready to contribute from day one in the digital economy.",
        bgImage: "/hero-full.webp",
        cta: "Apply Online",
      },
    ],
  ...
  faculty: [
    ...
    },
    {
      ...
      desc: "Cybersecurity professional combining industry, teaching, and research experience, with 3 publications and strong technical expertise.",
  ...
  corporateConnect: {
    eyebrow: "INDUSTRY SESSIONS & WORKSHOPS",
    title: "Corporate Connect",
    description:
      "Watch interactive tech sessions, industry talks, and workshops led by top tech executives.",
    videos: [
      { id: "FfF5LPxqH-Q", title: "Corporate Connect Session" },
      { id: "2HEHlEXRhK4", title: "Tech Leadership Talk" },
      { id: "8Xt5ax3WcVU", title: "Industry Mentorship Series" },
      { id: "3tPAa7VhArg", title: "Executive Tech Talk" },
      { id: "CKOeVkJiqBA", title: "Industry Innovation Summit" },
    ],
  },
  ...
  brochure: {
    ...
    fileName: "School_of_Computer_Science_Brochure.pdf",
  },
