...
export const spBansalSchool: ProgramPageData = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "Rooted in a 1985 educational legacy, SPBSB provides student-centered business education, executive coaching, live corporate consultancy projects, and incubation support for high-impact startups.",
    ],
