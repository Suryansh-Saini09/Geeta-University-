...
export const forensicSciencesSchool: ProgramPageData = {
  ...
  placement: {
    ...
    recruiters: [
      { name: "Central & State FSLs" },
      { name: "Deloitte Forensics" },
      { name: "EY Cyber & Fraud Investigation" },
      { name: "PwC Risk Advisory" },
      { name: "KPMG Forensics" },
      { name: "State Police Departments" },
      { name: "National Cyber Security Cell" },
      { name: "Biocon" },
      { name: "Dr. Reddy's Laboratories" },
      { name: "Sun Pharma" },
      { name: "Bureau of Police Research (BPR&D)" },
